    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50/50 to-background dark:from-sky-950/20 dark:to-background">
      ...
      <section className="py-12 md:py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="md:text-5xl font-bold tracking-tight text-foreground mb-4 text-[41px]">
          ...
          <Card className="shadow-md">
            <CardContent className="p-6 md:p-8">
              ...
              <Textarea
                ...
                className="min-h-24 resize-none text-base focus:border-primary focus:ring-primary"
                value={feedback}
                onChange={(e) => {
